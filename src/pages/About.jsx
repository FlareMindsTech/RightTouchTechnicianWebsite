...
const About = () => {
  ...
  return (
    <div className="container my-5">
      <div className="text-center mb-5 scroll-reveal reveal-up">
        ...
        <p className="lead text-secondary">Connecting skilled professionals with homes that need a "Right Touch."</p>
      </div>

      <div className="row align-items-center mb-5 scroll-reveal reveal-up reveal-delay-1">
        <div className="col-md-6">
          <h2 className="fw-bold mb-3">Who We Are</h2>
          <p>Right Touch is a leading home service marketplace. We specialize in <strong>technician services</strong>, ensuring that your essential devices are always in top condition.</p>
          <p>Our platform bridges the gap between expert technicians and customers, focusing on transparency and safety.</p>
        </div>
        <div className="col-md-6">
          <div className="p-4 bg-light rounded-4 border-start border-success border-5">
            <h4 className="fw-bold">Our Vision</h4>
            <p className="mb-0">To empower thousands of service professionals with consistent work and professional training.</p>
          </div>
        </div>
      </div>
        ...
        {["KYC Verification", "3-Day Training", "Live Bookings"].map((step, index) => (
          <div className="col-md-4 scroll-reveal reveal-up" key={index}>
            <div className="card h-100 border-0 shadow-sm p-3">
              ...
              <p className="small text-secondary">Detailed process to ensure only the best technicians serve our customers.</p>
            </div>
          </div>
        ))}
      </div>
  ...
  {/* Play store */}
      <div className="bg-light p-5 rounded-5 text-center shadow-sm scroll-reveal reveal-up reveal-delay-1">
        <h3 className="fw-bold mb-3">Ready to join our expert team?</h3>
